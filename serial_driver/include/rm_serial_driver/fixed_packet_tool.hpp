...
class FixedPacketTool {
 public:
  ...
  std::string get_error_message() { return transporter_->error_message(); }
...
template <int capacity>
bool FixedPacketTool<capacity>::simple_send_packet(
    const FixedPacket<capacity> &packet) {
...
template <int capacity>
bool FixedPacketTool<capacity>::send_packet(
    const FixedPacket<capacity> &packet) {
...
#endif  // RM_SERIAL__FIXED_PACKET_TOOL_HPP_
